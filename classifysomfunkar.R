...
# Duration removed - because problematic (?). But tempo stays?? Probably best removed: Definitely time_signature. Probably key and mode as well.
f = label ~ danceability + energy+ loudness + speechiness + acousticness + instrumentalness + liveness + valence + tempo +duration  + time_signature 
